...
impl AttributeIndex {
    ...
    pub fn update_bounds_and_histograms(
        ...
        let _s1 = span!("AttributeIndex::update_bounds_and_histograms");
    ...
    pub fn cell_overlaps_with_bounds(
        ...
        let _s1 = span!("AttributeIndex::cell_overlaps_with_bounds");
    ...
    fn load_from_file(num_lods: usize, file_name: &Path) -> Result<Arc<Index>, std::io::Error> {
        let _s1 = span!("AttributeIndex::load_from_file");
    ...
    pub fn write_to_file(&self) -> Result<(), std::io::Error> {
        let _s1 = span!("AttributeIndex::write_to_file");
