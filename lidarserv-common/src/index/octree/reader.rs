    ...
    SamplF: SamplingFactory<Point = Point, Sampling = Sampl>,
{
    ...
    fn cell_matches_query_impl(
        ...
        let _s1 = span!("cell_matches_query_impl");
        ...
        if enable_attribute_acceleration {
            let _s2 = span!("cell_matches_query_impl::attribute_acceleration");
    ...
    pub fn wait_update_or<T>(
        ...
        #[allow(clippy::never_loop)] // wrongly detected because of select! macro
        loop {
