...
def main():
    ...
    for file in all_files:
        ...
        plot_insertion_rate_over_time(
            data,
            title=title,
            filename=join(OUTPUT_FOLDER, f"insertion_rate_over_time_{file.name}.pdf"), 
        )
...
def plot_insertion_rate_over_time(data, filename: str, title=None):
    test_runs = data["runs"]["main"]
