    ...
    I: Index<Point>,
{
    json!({
        ...
        "normal_x_vertical": measure_one_query(&mut index, aabb_full(), normal_x_vertical()),
        "building_classification": measure_one_query(&mut index, aabb_full(), building_classification()),
        ...
        "mixed_ground_normal_one_return": measure_one_query(&mut index, aabb_full(), mixed_ground_normal_one_return()),
    })
}
