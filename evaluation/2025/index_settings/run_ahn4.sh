...
DATA_DIR="../../../data/ahn4"
POINT_FILE="/media/hermann/Paul 500/ahn4.las"
QUERY="full"
...
cp ahn4.json "$DATA_DIR/settings.json"
...
nohup cargo run --release --bin lidarserv-input-file -- replay "$POINT_FILE" --autoskip > input_file.log 2>&1 &
sleep 5
