...
use crate::renderer::settings::{PointCloudRenderSettings, BaseRenderSettings, AnimationSettings};
...
pub enum RendererCommand {
    ...
    AddCameraSubscriber {
        window_id: WindowId,
        result_sender: crossbeam_channel::Sender<RendererResult<crossbeam_channel::Receiver<Matrices>>>
    }
}
